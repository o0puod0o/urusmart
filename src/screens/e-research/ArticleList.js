      ...
      <ScrollView ref={scrollRef} contentContainerStyle={{ padding: 14, paddingBottom: 40 }} showsVerticalScrollIndicator={false}>
        ...
        <View className="bg-white border border-[#eef1f4] rounded-2xl overflow-hidden mb-4" style={{ elevation: 1 }}>
          <View className="flex-row items-center bg-[#007a5a] px-[14px] py-[11px]">
            ...
            <Text className="text-white text-[13px] font-extrabold flex-[3]">{te("article.tableTitle")}</Text>
            <Text className="text-white text-[13px] font-extrabold flex-1 text-center">{te("common.file")}</Text>
          ...
          {loading || sessionLoading ? (
            ...
            <View className="items-center py-9 px-5">
              ...
              <Text className="text-[14px] font-bold text-[#8b2f2f] mt-[10px] text-center">{te("article.loadFailed")}</Text>
            ...
            <View className="items-center py-9">
              ...
              <Text className="text-[14px] font-bold text-[#1f2a2e] mt-[10px]">{te("article.emptyTitle")}</Text>
              <Text className="text-[12px] text-[#6b7a82] mt-1">{te("article.emptyHint")}</Text>
            </View>
          ) : (
            items.map((item, index) => {
              ...
              <View key={item.id} className="flex-row items-center px-[14px] py-3 border-t border-[#eef1f4]">
                ...
                >
                  <Text className="text-[13px] font-semibold text-[#1f2a2e]" numberOfLines={2}>{item.title_th || "-"}</Text>
                  <Text className="text-[11px] text-[#8fa89f] mt-[2px]">{item.source || "-"}</Text>
                </TouchableOpacity>
                <TouchableOpacity
