...
const HumanSubjectsForm = ({ navigation }) => {
  ...
  const handleSave = async () => {
    if (!form.year || !form.title.trim() || !form.evidenceUrl.trim()) {
      Alert.alert("แจ้งเตือน", "กรุณาเลือกปี กรอกหัวข้อ และใส่ลิงก์หลักฐาน");
      return;
    }
    ...
    try {
      ...
      Alert.alert(
        "บันทึกไม่สำเร็จ",
        "ยังเชื่อมต่อ API ไม่ได้ กรุณาตรวจสอบ BASE_URL และ endpoint human-subjects",
      );
    } finally {
      setSaving(false);
    }
      ...
      { text: "ยกเลิก", style: "cancel" },
      {
        ...
        onPress: async () => {
          try {
            ...
            Alert.alert(
              "ลบไม่สำเร็จ",
              "ยังเชื่อมต่อ API ไม่ได้ กรุณาตรวจสอบ endpoint human-subjects",
            );
          }
        },
      },
    ...
    <View style={styles.container}>
      ...
      >
        <View style={styles.hero}>
          ...
          <View style={{ flex: 1 }}>
            <Text style={styles.eyebrow}>อบรมมาตรฐานจริยธรรม</Text>
          ...
          {loading ? (
            ...
            <View style={styles.emptyWrap}>
              ...
              <Text style={styles.emptyHint}>
                เพิ่มข้อมูล {COURSE_TITLE} รายการแรกได้ในแบบฟอร์มด้านล่าง
              </Text>
            </View>
          ) : (
        ...
        <View style={styles.formCard}>
          ...
          <Text style={styles.formSubtitle}>กรอกข้อมูล {COURSE_TITLE}</Text>
          ...
          <View style={styles.fieldWrap}>
            <Text style={styles.fieldLabel}>
              หัวข้อ {COURSE_TITLE}:<Text style={styles.required}> *</Text>
            </Text>
            <TextInput
              style={styles.input}
              value={form.title}
          ...
          <View style={styles.fieldWrap}>
            <Text style={styles.fieldLabel}>
              ลิงก์หลักฐาน:<Text style={styles.required}> *</Text>
            </Text>
            <TextInput
              style={styles.input}
