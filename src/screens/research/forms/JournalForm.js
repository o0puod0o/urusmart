    ...
    <View style={styles.fieldWrap}>
      ...
      >
        <Text
          ...
          numberOfLines={1}
        >
          {selected?.id ? selected.label : options[0]?.label || "กรุณาเลือก"}
        </Text>
        <Ionicons
...
const JournalForm = ({ navigation }) => {
  ...
  // TODO: ดึงจาก API → GET /api/journal-databases
  const [databaseOptions, setDatabaseOptions] = useState([
    { id: "", label: "กรุณาเลือกฐานข้อมูล" },
  ]);
  ...
  const handleSave = async () => {
    if (!form.year || !form.reference.trim() || !form.database) {
      Alert.alert("แจ้งเตือน", "กรุณาเลือกปี กรอกอ้างอิง และเลือกฐานข้อมูล");
      return;
    }
    const payload = {
      year: form.year,
      ...
      >
        ...
        <View style={styles.card}>
          ...
          {loading ? (
            ...
            <View style={styles.emptyWrap}>
              ...
              <Text style={styles.emptyText}>ยังไม่มีข้อมูล Journal</Text>
            </View>
          ) : (
            <ScrollView horizontal showsHorizontalScrollIndicator={false}>
              <View>
                <View style={styles.tableHead}>
                  ...
                  <Text style={[styles.th, styles.col_ref]}>อ้างอิง</Text>
                  <Text style={[styles.th, styles.col_db]}>ฐานข้อมูล</Text>
                  <Text style={[styles.th, styles.col_act]}>แก้ไข</Text>
                  <Text style={[styles.th, styles.col_act]}>ลบ</Text>
                </View>
        ...
        <View style={styles.card}>
          <Text style={styles.formTitle}>
            {editingItem
              ? "✏️  แก้ไขข้อมูล Journal"
              : "เพิ่มข้อมูลบทความวิจัย/วิชาการ (Journal)"}
          </Text>
